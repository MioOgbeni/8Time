...
class _TimelinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final indicatorMargin = indicatorRadius + indicatorRadius;

    final bottom = size.bottomLeft(Offset(indicatorRadius, 0.0));
    final centerBottom = size.topLeft(
      Offset(indicatorRadius, indicatorMargin + 10.0),
    );
